    ...
    <div class="fixed w-full shadow bg-gray-100">
      <div class="container m-auto px-4 py-4">
        <nav class="flex justify-between">
          <div>
            <router-link :to="{ name: 'upcoming-events'}" class="nav-link text-sm md:text-xl text-gray-600 mr-4 relative"><span class="font-thin">Upcoming</span> Events</router-link>
            <router-link :to="{ name: 'past-events'}" class="nav-link text-sm md:text-xl text-gray-600 relative"><span class="font-thin">Past</span> Events</router-link>
          </div>
